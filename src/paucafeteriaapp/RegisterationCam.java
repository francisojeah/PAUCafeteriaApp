 ...
 * @author ojeah
 */
public class RegisterationCam extends javax.swing.JFrame {
    
    static {
        File file = new File("C:\\Users\\ojeah\\Documents\\NetBeansProjects\\PAUCafeteriaApp\\src\\required\\opencv_java249.dll");
    ...
    /**
     * Creates new form RegisterationCam
     */
    public RegisterationCam() {
        initComponents();
    ...
    private void CaptureImage(JLabel image) {
        try {
            ...
            if (getImage != null) {
                ...
                ImageIcon imageico = new ImageIcon(new ImageIcon(Filename).getImage().getScaledInstance(AdditionalReg.jLabel8.getWidth(), AdditionalReg.jLabel8.getHeight(), Image.SCALE_DEFAULT));
                AdditionalReg.jLabel8.setIcon(imageico);
            }
        } catch (Exception e) {
       ...
       int option = JOptionPane.showConfirmDialog(rootPane, "Are you sure you want to capture the image");
        if (option == 0) {
            try {
                ...
                AdditionalReg.jTextField2.setText(Filename);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegisterationCam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegisterationCam().setVisible(true);
            }
        });
    }
